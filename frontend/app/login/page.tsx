  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        <button className="btn-primary w-full" onClick={emailSignIn} disabled={loading || oauthLoading}>
          {loading ? <><Loader2 size={16} className="spin" /> Signing in...</> : <>Sign in <ArrowRight size={14} /></>}
        </button>
